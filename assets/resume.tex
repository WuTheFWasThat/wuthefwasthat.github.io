...
interested in keeping the world safe for everyone as technologies such as language models become more powerful \\
...
% \item \textbf{Independent} \hfill May 2026 -- \\
% Working on AI auditing, alignment standards, and other projects related to coordination and oversight of frontier AI.


\item \textbf{Anthropic} Research engineer \hfill Dec 2024 -- May 2026 \\
  Worked on \href{https://transformer-circuits.pub/2026/nla/}{basic interpretability research} and \href{https://alignment.anthropic.com/2025/automated-auditing/}{automated alignment auditing}.

\item \textbf{OpenAI} Research engineer \hfill Aug 2018 -- Jul 2024 \\
  Worked on language modeling (including training \href{https://openai.com/blog/better-language-models/}{GPT-2}) and RLHF (trained initial \href{https://openai.com/blog/instruction-following/}{GPT instruct} series models).  Managed teams and projects working on scalable oversight, generalization, and interpretability.
...
$\bullet$ Deep learning and machine learning (especially language modeling, RL, alignment, and interpretability)
